...
/**
 * Regression tests for clingen-mcp-server structuredContent responses.
 */
...
if (index) {
  assertContains('src/index.ts', index, 'ClingenDataDO', 'index exports ClingenDataDO');
...
if (codeMode) {
  assertContains('src/tools/code-mode.ts', codeMode, 'clingen_search', 'code-mode registers clingen_search');
  assertContains('src/tools/code-mode.ts', codeMode, 'clingen_execute', 'code-mode registers clingen_execute');
}

if (queryData) {
  assertContains('src/tools/query-data.ts', queryData, 'clingen_query_data', 'registers clingen_query_data');
}

if (getSchema) {
  assertContains('src/tools/get-schema.ts', getSchema, 'clingen_get_schema', 'registers clingen_get_schema');
}
