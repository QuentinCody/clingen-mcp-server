...
import { ClingenDataDO } from "./do";

// Export Durable Object classes
export { ClingenDataDO };

interface ClingenEnv {
...
export class MyMCP extends StatelessMcpWorker {
    ...
    async init() {
        ...
        const env = this.env as unknown as ClingenEnv;
...
export default {
    fetch(request: Request, env: Env, ctx: ExecutionContext) {
        ...
        if (url.pathname === "/health") {
            return buildHealthResponse("clingen");
        }
        ...
        if (url.pathname === "/readyz") {
            ...
            return MyMCP.readiness(env, "clingen");
        }
